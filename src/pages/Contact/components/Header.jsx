export default function Header() {
    return (
      <section className="p-0 bg-dark-gray">
        <div
          className="swiper lg-no-parallax full-screen md-h-600px sm-h-500px swiper-light-pagination ipad-top-space-margin "
          ...
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide overflow-hidden">
              <div
                ...
                style={{ backgroundImage: "url('/images/SAAG/Contactanos-SAAG.png')" }}
                data-swiper-parallax="1000"
              >
                <div className="opacity-light bg-gradient-black-green"></div>
                  ...
                  <div className="row align-items-center justify-content-center h-100 text-center">
                    <div className="col-xl-7 col-lg-9 col-md-10 position-relative text-white">
                      ...
                      <span
                        ...
                        data-fancy-text='{"effect":"rotate","string":["Contacta a nuestro equipo para una prueba de manejo "]}'
                      ></span>
