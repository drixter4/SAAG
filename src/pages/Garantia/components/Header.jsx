        ...
        >
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide overflow-hidden">
              <div
                className="cover-background2 position-absolute top-0 start-0 w-100 h-100"
                style={{ backgroundImage: "url('/images/SAAG/Posventa-Atencional-cliente.webp')" }}
                data-swiper-parallax="1000"
              >
                <div className="opacity-full-dark"></div>
                  ...
                  <div className="row align-items-center justify-content-center h-100 text-center">
                    <div className="col-xl-7 col-lg-9 col-md-10 position-relative text-white">
                      ...
                      <span
                        ...
                        data-fancy-text='{"effect":"rotate","string":["Garantias SAAG"]}'
                      ></span>
